      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy">
                <?php echo lang('thanks_for_joining'); ?>
                <br />
                <?php echo lang('email'); ?> : <strong><?php echo esc_output($candidate['email']); ?></strong>
                <br />
                <br />
                <?php echo lang('finish_signing_up'); ?>
              </td>
            </tr>
            <tr>
                ...
                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="button" height="45">
                      <a target="_blank" href="<?php echo CF_BASE_URL; ?>/activate-account/<?php echo esc_output($candidate['token']); ?>">
                        <?php echo lang('activate_account'); ?>
                      </a>
                    </td>
                  </tr>
                </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" class="footercopy">
                &copy; <?php echo lang('copyrights'); ?> <?php echo date('Y'); ?> : <?php echo lang('all_rights_reserved'); ?>
              </td>
            </tr>
          </table>
        </td>
