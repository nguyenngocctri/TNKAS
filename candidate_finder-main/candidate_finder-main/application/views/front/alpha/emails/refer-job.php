      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                <?php echo lang('Hello'); ?> <strong> <?php echo esc_output($name, 'html'); ?></strong>
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                <?php echo lang('your_friend_colleague'); ?> "<?php echo esc_output($user, 'html'); ?>" <?php echo lang('has_referred_job'); ?>
                <br />
              </td>
            </tr>
            <tr>
