...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-cube"></i> <?php echo lang('job_filters'); ?><small></small></h1>
    <ol class="breadcrumb">
      ...
      <li class="active"><i class="fas fa-cube"></i> <?php echo lang('job_filters'); ?></li>
    </ol>
  </section>
              ...
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  ...
                  <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-job-filter">
                    <i class="fa fa-plus"></i> <?php echo lang('add_job_filter'); ?>
                  </button>
                  <?php } ?>
                  <div class="btn-group">
          ...
          <div class="box-body">
            ...
            <table class="table table-bordered table-striped" id="job_filters_datatable">
              ...
              <tr>
                ...
                <th><?php echo lang('admin_filter'); ?></th>
                <th><?php echo lang('front_filter'); ?></th>
                <th><?php echo lang('front_home_filter'); ?></th>
                <th><?php echo lang('front_value'); ?></th>
                <th><?php echo lang('front_filter_type'); ?></th>
...
<!-- page script -->
<script src="<?php echo base_url(); ?>assets/admin/js/cf/job_filter.js"></script>
