...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/plugins/bootstrap-colorpicker/bootstrap-colorpicker.min.css">  
  <!-- jQuery Multiselect -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/css/AdminLTE.min.css?v=<?php echo time();?>">
  <!-- AdminLTE Skins -->
