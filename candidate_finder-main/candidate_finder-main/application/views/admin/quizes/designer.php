<!-- Content Wrapper Starts -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="far fa-list-alt"></i> <?php echo lang('quiz_designer'); ?></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-tachometer-alt"></i> <?php echo lang('home'); ?></a></li>
        <li class="active"><i class="far fa-list-alt"></i> <?php echo lang('quiz_designer'); ?></li>
      </ol>
    </section>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group question-bank-question-search">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo lang('search_questions'); ?>" id="questions_search" value="<?php echo esc_output($questions_search); ?>">
                          ...
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" id="questions_type">
                                <option value=""><?php echo lang('all'); ?></option>
                                <option value="radio" <?php sel($questions_type, 'radio'); ?>><?php echo lang('radio_single_true'); ?></option>
                                <option value="checkbox" <?php sel($questions_type, 'checkbox'); ?>><?php echo lang('checkbox_multiple_true'); ?></option>
                              </select>
                            </div>
                          </div>
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title quiz-page-quizes-title">
                <i class="far fa-list-alt"></i> <?php echo lang('quizes'); ?>
                &nbsp;
              ...
              <div class="row">
                <div class="col-md-8 col-sm-12">
                  <div class="input-group quiz-page-quiz-select-group">
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-default disabled btn-flat"><?php echo lang('select_quiz'); ?></button>
                    </span>
                    ...
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-quiz" 
                        id="edit-quiz" title="<?php echo lang('edit_selected_quiz'); ?>">
                    ...
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-danger btn-flat delete-quiz" title="<?php echo lang('delete_selected_quiz'); ?>"
                        id="delete-quiz">
