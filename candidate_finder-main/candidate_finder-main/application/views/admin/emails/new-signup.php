      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="bodycopy">
                <?php echo lang('new_user_signed_up'); ?> <?php echo setting('site-name'); ?>.
                <hr />
                <strong><?php echo lang('name'); ?></strong> : <?php echo esc_output($candidate['first_name'].' '.$candidate['last_name'], 'html'); ?><br /><br />
                <strong><?php echo lang('email'); ?></strong> : <?php echo esc_output($candidate['email'], 'html'); ?><br /><br />
              </td>
            </tr>
          </table>
        </td>
